...
import com.mrsburguer.mrsburguer.email.EmailSender;
...
import com.mrsburguer.mrsburguer.user.User;
import com.mrsburguer.mrsburguer.user.UserRole;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String link = "http://localhost:4000/api/registration/confirm?token=" + token;
    ...
    public String confirmToken(String token) {
        ...
        ConfirmationToken confirmationToken = confirmationTokenService.getToken(token)
                .orElseThrow(() -> new IllegalStateException("token not ofund"));
